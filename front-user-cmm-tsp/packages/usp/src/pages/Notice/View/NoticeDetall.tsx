...
const NoticeDetall = () => {
  ...
  const [pblancId, setPblancId] = useState<string>(currentUrl.split('?')[0].split('/')[4]);
        ...
        <div className="benner">
          ...
          >
            ...
            <Stack direction="row" className="tag" spacing={1}>
              ...
              : data.data.rmndrDay = 1 ? <Chip label={'오늘마감'} className="wh" />  : <Chip label={'마감'} className="wh" /> : null
              }
            </Stack>
          </Stack>
        </div>
            ...
            <Box css={styles.table01}>
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <th>선정규모</th>
                    <td>10 업체{!!data ?  data.data.slctnScale : ''}(명) 내외</td>
                    <th>모집대상</th>
