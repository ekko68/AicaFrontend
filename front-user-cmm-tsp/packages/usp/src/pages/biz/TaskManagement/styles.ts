...
export const sub_cont01 = css`
  ...
  .textfield_tp01{
    .MuiOutlinedInput-root{width:100%;height:120px;}
  }
  @media (min-width: 320px) and (max-width: 768px) {
    .tab_wrap {
      width:calc(100% - 15px);
  ...
  .tableDefault{
    .MuiOutlinedInput-root{width:85%;}
    &.type5{
      min-width: 670px;
      .MuiOutlinedInput-root{
        width:100%;
  ...
  .detail_table {
    .MuiOutlinedInput-root{width:84%;}
  }
  .textfield_tp01{
    .MuiOutlinedInput-root{width:100%;height:140px !important;font-size:14px;font-weight:300;}
  }
}
`;
...
export const list_select = css`
  li {
    ...
    p{
      ...
      i{font-style:normal;font-size:20px;color:#4063ec;}
      span{font-size:14px;color:#4063ec}
    }
