...
export const sub_cont01 = css`
  ...
  .objection_content{line-height: 26px;padding:21px 20px;border-top:1px solid #1f2437;border-bottom:1px solid #e0e0e0;font-weight:300;}
  .txtbox {
    margin: 0 auto;
    max-width: 1080px;
    width: 100%;
  ...
  @media (min-width: 320px) and (max-width: 768px) {
    ...
    .objection_content{font-size:14px;}
    .bottom_card {
      height: 48px;
