...
/*
    컴포넌트: ConfirmInfoTable
    개발자  : seok
    작성일  : 20220627
*/

export const ConfirmInfoTable: React.FC<{
...
export const ListItem: React.FC<{
    ...
    const onChangeNumber = (event:any) => {
        if (event.currentTarget == null || event.currentTarget.value>100) {
          return;
        }
        event.preventDefault();
        const update = {...props.data,[event.currentTarget.name]: event.currentTarget.value.replace(/[^0-9]/g,'')};
        props.updateItem(update,props.i);
      };
