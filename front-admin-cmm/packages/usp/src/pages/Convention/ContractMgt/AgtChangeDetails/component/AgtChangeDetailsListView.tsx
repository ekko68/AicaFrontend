...
import { SearchParam,CnvnChange } from "~/pages/Convention/ContractMgt/AgtChangeDetails/Model";
import { AgtChangeDetailsListViewHeadCells as headCells } from "~/pages/Convention/ContractMgt/AgtChangeDetails/helper"

import { AgtChangeDetailsService } from "~/pages/Convention/ContractMgt/AgtChangeDetails/Service/AgtChangeDetailsService";
import { fetchDownload } from '~/fetches';

export const AgtChangeDetailsListView: React.FC<{ searchParam?: SearchParam}> = props => {
    ...
    const dataSource = AgtChangeDetailsService.getList({...pagination, ...props.searchParam});
    useEffect(() => {
    ...
    return <TableComponents<CnvnChange>
      ...
      handleClick={(key: string) => {
        console.log('######################################################################88')
        console.log(key)
        navigation('/Convention/ContractMgt/AgtChangeDetails/'+key);
      }}
