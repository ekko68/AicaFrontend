...
export const ArchiveMgtRegi = () => {
  ...
  return <TitleContents title={"자료 등록"}>
    <Stack style={{marginTop: '40px'}} width={'100%'} id={'Archive'}>
        ...
        <CustomButton
          ...
          onClick={() => {
            if (checkValidity('Archive')) {
              ...
              navigate('/OperationMgt/CustomerSupportMgt/ArchiveMgt/1157')
            }
