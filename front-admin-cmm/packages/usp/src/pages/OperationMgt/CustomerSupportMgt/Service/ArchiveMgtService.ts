...
import {자료실} from "~/pages/OperationMgt/CustomerSupportMgt/Model/Model";

export class ArchiveMgtService {
  static getList(param: {
    ...
    rowCount: number
    rowsPerPage: number
  }): UseQueryResult<WithResponse<WithPagination<자료실>>, any> {
    return GetQuery("/", {...param, page: param.page + 1, itemsPerPage: param.rowsPerPage})
  }

  // static getHistInfo(archiveMgtId: string, param: {
  //   page: number,
  //   rowsPerPage: number,
  //   rowCount: number
