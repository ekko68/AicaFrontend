...
export const PostQuery = (url: string, data?: any, reqOpts?: RequestOptions, queryOpts?: UseQueryOptions) => {
  return useQuery([url, data], () => _request('POST', url, data, reqOpts), queryOpts);
}

export const DeleteQuery = (url: string, data?: any, reqOpts?: RequestOptions, queryOpts?: UseQueryOptions) => {
