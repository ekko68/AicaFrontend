...
import {ApplyResourceDetailData, EqpmnUseReqstDetail} from "~/service/Model";
...
export const ApplyResourceinfo = () => {
  ...
  return <Fragment>
        ...
        <TableContainer style={{borderTop: "1px solid #d7dae6"}}>
          <Table>
            <TableBody>
              <TableRow>
                <TableTextCell
                  division title={"신청상태"} label={state.reqstSttus}
    ...
    {spmopen && <SpmModal open={spmopen} setOpen={setSpmOpen} setState={setState}/>}
    {rejopen && <RejectModal open={rejopen} setOpen={setRejOpen} setState={setState}/>}
  </Fragment>
}
