        ...
        <TableBody>
          {
            rowList.map((m, i) => {
              return <TableRow key={i} sx={{borderLeft: '1px solid #d7dae6', borderRight: '1px solid #d7dae6',}}>
                ...
                <StyledTableCell sx={{minWidth: '90px'}}><span>{dayFormat(m.createDt)}</span></StyledTableCell>
                ...
                <TableCell sx={{minWidth: '90px', textAlign: 'center'}}><span>{arr[i]}</span></TableCell>
              </TableRow>
            })
          }
          <TableRow sx={{borderLeft: '1px solid #d7dae6', borderRight: '1px solid #d7dae6',}}>
