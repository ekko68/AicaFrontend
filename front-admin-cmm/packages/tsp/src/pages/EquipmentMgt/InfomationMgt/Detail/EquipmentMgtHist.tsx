  ...
  return <Stack spacing={"40px"}>
    ...
    <TableComponents<EquipmentMgtHistData>
      ...
      tableCell={(data) => {
        ...
        return (
          data ? <Fragment>
            <TableCell key={"manageDiv-" + data.key} sx={{paddingLeft: "30px"}}>{manageDiv}</TableCell>
            <TableCell key={"manageBeginDt-" + data.key}>{dayFormat(data.manageBeginDt)}</TableCell>
            <TableCell key={"manageEndDt-" + data.key}>{dayFormat(data.manageEndDt)}</TableCell>
            <TableCell key={"manageResult-" + data.key}>{data.manageResult}</TableCell>
            <TableCell key={"crrcInstt-" + data.key}>{data.crrcInstt}</TableCell>
