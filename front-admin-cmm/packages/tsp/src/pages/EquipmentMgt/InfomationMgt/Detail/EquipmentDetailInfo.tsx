...
import {
  CustomHeadCell,
  TableComponents, TableDoubleSelectCell,
  TableRadioCell,
  TableSelectCell,
          ...
          <TableBody>
            <TableRow>
              <TableRadioCell
                ...
                defaultLabel={`${detail.detailInfoData.srcelct}v`}
                thWidth={"13%"} tdWidth={"21%"}
