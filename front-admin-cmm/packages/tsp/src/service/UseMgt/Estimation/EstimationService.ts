...
export class EstimationService {
  ...
  static putEstmtModifyPrice(estmtId: string, data: EqpmnEstmtModifyPrice) : Promise<WithResponse<EqpmnEstmtDetailData>> {
    return AxiosPut('/eqpmns/estmts/' + estmtId, data)
  }

  // 견적신청 처리내역 조회
  static getTsptEqpmnEstmtReqstHist(param:{page: number, rowsPerPage:number}) : UseQueryResult<WithResponse<WithPagination<TsptEqpmnEstmtReqstHist>>,any> {
    return GetQuery("/eqpmns/estmts/hist-list", {...param, page: param.page +1, itemsPerPage:param.rowsPerPage})
  }
