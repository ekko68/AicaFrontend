...
import {
  ...
  ApplyResourceDetailData, ApplyResourceRejectProcess, ApplyResourceSpmProcess, WithPagination
} from "~/service/Model";
...
export class ApplyResourceService {
  ...
  static getProcessHistoryList(reqstId: string, param: {
    ...
    rowsPerPage: number,
    rowCount: number
  }) : UseQueryResult<WithResponse<WithPagination<ApplyResourceDetailData>>, any> {
    return GetQuery('/resrce/' + reqstId + '/hist/', {page: param.page + 1, itemsPerPage: param.rowsPerPage})
  }
