...
export type CodeGroup = "EQPMN_AVAILABLE_ST" | "EQPMN_ESTMT_ST" | "EQPMN_RENTAL_REPORT_ST" |
  ...
  "EQPMN_TKOUT_ST" | "EQPMN_USAGE_ST" | "EQPMN_EXTEND" | 'EQPMN_REQST_ST' | 'EQPMN_PAYMENT'
...
export interface EqpmnEstmtDetailData {
  ...
  modelNm: string, /*모델명*/
  ofcps: string, /*직위*/
  partcptnAt: boolean, /*ai직접단지 사업참여 여부*/
  pymntMth: string, /*지불방법*/
  rceptNo: string, /*접수번호*/
  reqstSttus: string, /*신청상태*/
...
export interface EqpmnUseReqstDetail {
  ...
  npyResn: string, /*미납사유*/
  ofcps: string, /*직위*/
  partcptnAt: boolean, /*AI 직업단지 사업참여 여부*/
  pymntMth: string, /*지불방법*/
  rceptNo: string, /*접수번호*/
...
export interface EqpmnExtndDetail {
  ...
  partcptnAt: string, /*AI 직접단지 참여사업*/
  pymntMth: string, /*지불방법*/
  rceptNo: string, /*접수번호*/
...
export interface EqpmnsExtndHistList {
  ...
  etReqstId: string, /*연장신청 ID*/
  histId?: string, /*이력 ID*/
  memberId: string, /*처리자 ID*/
  memberNm?: string, /*처리자이름*/
...
export interface ApplyResourceDetailData {
  ...
  mberDiv: string /*구분*/
  ofcps: string /*직위*/
  partcptnAt: boolean /*AI 집적단지 사업자명 여부*/
  rceptNo: string /*접수번호*/
  reqstSttus: string /*신청상태*/
  useprps: string /*활용목적*/
  userNm: string /*이름*/
...
export interface UseResourceDetailData {
  ...
  mberDiv: string /*구분*/
  ofcps: string /*직위*/
  partcptnAt: boolean /*AI 집적단지 사업참여 여부*/
  rceptNo: string /*접수번호*/
  reqstSttus: string /*신청상태*/
