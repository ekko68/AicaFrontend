...
import {ApplicantInformation} from "~/pages/Apply/Estimation/ApplyEstimation/ApplyEstimationDetail/ApplyWrite";
...
export const ApplicationForm: React.FC<{
  ...
  const [userApplicantInformation, setUserApplicantInformation] = useState<ApplicantInformation>(tempData);
    ...
    <Stack width={"100%"} spacing={"41px"} component={'form'} id={'applicationForm'}>
      ...
      <SubContents
        ...
        <CustomInfoTable columnCount={columnCount} elements={[
          ...
          <TableTextFieldCell
            ...
            label={"직위"}
            onChange={(s) => {
              setUserApplicantInformation({...userApplicantInformation, position: s})
            }}
          />,
          <TableTextFieldCell
            thWidth={100} tdWidth={200}
            ...
            defaultLabel={""}
            onChange={(s) => {
              setUserApplicantInformation({...userApplicantInformation, callNb: s})
            }}
          />,
          <TableTextFieldCell
            thWidth={100} tdWidth={200}
            ...
            defaultLabel={""}
            onChange={(s) => {
              setUserApplicantInformation({...userApplicantInformation, email: s})
            }}
          />,
          <TableRadioCell
            thWidth={100} tdWidth={200}
            ...
            onClick={(s) => {
              setUserApplicantInformation({...userApplicantInformation, AI: s})
            }}
          />,
        ]}/>
        <Box
      ...
      <SubContents maxHeight={'100%'} title={"신청장비 및 지불방법"} marginBottom={'20px'}>
        <CustomInfoTable columnCount={columnCount} elements={[
          ...
          <TableSelectCell
            ...
            onClick={(s) => {
              setUserApplicantInformation({...userApplicantInformation, payment: s})
            }}
          />,
        ]}/>
      </SubContents>
      ...
      <SubContents title={"활용목적"} maxHeight={"100%"} required>
        <SimpleTextField required multiline wordCount={1000} fullWidth row={6}
                         onChange={(s) => {
                           setUserApplicantInformation({...userApplicantInformation, purposeUse: s})
                         }}/>
      </SubContents>
      ...
      <SubContents title={"반출신청"} maxHeight={"100%"}>
        <CustomInfoTable columnCount={columnCount} elements={[
          <TableRadioCell
            ...
            radioLabel={["반출안함", "반출"]}
            onClick={(s) => {
              setUserApplicantInformation({...userApplicantInformation, carry: s})
            }}
          />,
          <TableTextFieldCell
            thWidth={100} tdWidth={200}
            ...
            defaultLabel={""}
            onChange={(s) => {
              setUserApplicantInformation({...userApplicantInformation, address: s})
            }}
          />,
          <TableTextFieldCell
            thWidth={100} tdWidth={200}
            ...
            tdSpan={3}
            onChange={(s) => {
              setUserApplicantInformation({...userApplicantInformation, purpose: s})
            }}
          />, <></>,
      ...
      <TableRow>
        <Box display={"flex"} justifyContent={"center"} style={{marginBottom: "40px"}}>
          <CustomButton label={"이전"} color={"outlinedblack"}
                        style={{borderRadius: "30px", width: '140px',height:'60px'}}
                        onClick={() => {
                          navigate(-1);
                        }}
          />
          <Box width={"20px"}/>
          <CustomButton label={"다음"} style={{borderRadius: "30px", width: '140px', height:'60px'}}
                        onClick={() => {
...
const tempData: ApplicantInformation = {
  position: '',
  callNb: '',
  email: '',
  AI: '',
