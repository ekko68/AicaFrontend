...
import {Box, debounce, Drawer, FormControlLabel, MenuItem, Select, Stack, TextField} from "@mui/material";
              ...
              if (newValue[0] && newValue[1]) {
                ...
                splitTime.some(s => {
                  ...
                  if (startTime <= compare.getTime() && compare.getTime() < endTime) {
                    ...
                    addModal({open: true, title:'제목', content: `${s}일 까지 사용 가능 합니다.`,buttonName:'아니오', outlined:true})
                    return true;
                  }
                })
              }
        ...
        {props.date && <><Select size={'small'} sx={{minWidth: "140px"}} value={day} onChange={handleChange}>
          {props.selectTime.map((value, index) => {
            ...
            <Box sx={{display: "flex", alignItems: "center"}}>
                <TextField size={"small"} sx={{maxWidth: "100px", minWidth: "120px", paddingX: "5px"}}/>
                <Body3>분</Body3>
            </Box></>}
      </Stack>
    </Stack>
