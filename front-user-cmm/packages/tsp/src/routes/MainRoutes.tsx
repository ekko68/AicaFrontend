...
export const MainRoutes: RouteType[] = [
        ...
        route={middleware(
          {
            label: 'dashboard',
            layout: 'basic',
            element: React.lazy(() => import("../pages/ApplyResource/ApplyResource")),
          },
          []
        )}
      />
  ...
  },
  {
        ...
        route={middleware(
          {
            label: 'dashboard',
            layout: 'basic',
            element: React.lazy(() => import("../pages/Temp/ApplyEstimationDetail/ApplyEstimationDetail")),
          },
          []
        )}
      />
    ...
    path: '/tsp/Mypage/Estimation/MyPageEstimationDetail',
    label: '실증장비상세',
    element: (
      <Loader
        route={middleware(
    ...
    path: '/tsp/Mypage/Resource/MyPageResourceDetail',
    label: '실증자원사용상세',
    element: (
      <Loader
        route={middleware(
