	...
	if (typeof ML4WebUI === "undefined") {
		var _ML4WebUI = {
			...
			init : function(callback){
				//var mainPageUrl = "UI/ML4Web_Main.jsp";
				var mainPageUrl = "UI/ML4Web_Main.html";
				
				$("#selectCertContainer").load(mainPageUrl + "?random=" + Math.random() * 99999, function(){
					/*
					$("#ML_window").MLjquiWindow('open', function(e){
			...
			saveCertInit : function(callback){
				//var savePageUrl = "UI/ML4Web_SaveCertMain.jsp";
				var savePageUrl = "UI/ML4Web_SaveCertMain.html";

				$("#selectCertContainer").load(savePageUrl + "?random=" + Math.random() * 99999, function(){
					/*
					$("#ML_window").MLjquiWindow('open', function(e){
						$('#certaction').val('MakeSignData');
						callback(200);
