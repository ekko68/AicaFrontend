...
const magicline:magiclineType = {
  uiapi : null,
  initCallback : null,
  is_ML_Sign_Init:false
}

type callbackType = (code:any, message:any) => void
...
const useScript = (src:string) =>{
  ...
  },[src]); // Only re-run effect if script src change
  return status;
}
...
// 	 * send 할 메시지를 생성
// 	 */
// 	const MakeRequestJsonMessage = ( functionName:any, functionParameter:any, option:any ) =>{
// 		var temp = 
// 			{
...
// 	 * SignedData
// 	 */
// 	const MakeSignData = ( msg:any , signOpt:any, callback:any ) => {
...
// 	function CommonResopnseProcess( json:any ){
