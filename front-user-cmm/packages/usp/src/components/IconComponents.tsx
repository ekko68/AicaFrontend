...
//header Search button 아이콘
export const GNB_searchIcon: React.FC<{
}> = (props) => {
  return (
    <img src="/images/common/icon_GNB_search.png" width={30} />
  );
}
...
export const TrashIcon: React.FC<{
  ...
  return (
    <img src="/images/common/icon_trash.png" width={24} />
  );
}
...
export const PlusIcon: React.FC<{
  ...
  return (
    <img src="/images/common/icon_plus.png" width={24} />
  );
}
